...
/* Drop file */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_onNativeDropFile(
...
/* Resize */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_onNativeResize(
                                    JNIEnv* env, jclass jcls,
...
/* Paddown */
JNIEXPORT jint JNICALL Java_org_libsdl_app_sdl_SDLActivity_onNativePadDown(
                                    JNIEnv* env, jclass jcls,
...
/* Padup */
JNIEXPORT jint JNICALL Java_org_libsdl_app_sdl_SDLActivity_onNativePadUp(
                                   JNIEnv* env, jclass jcls,
                                   jint device_id, jint keycode)
{
...
/* Joy */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_onNativeJoy(
                                    JNIEnv* env, jclass jcls,
...
/* POV Hat */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_onNativeHat(
                                    JNIEnv* env, jclass jcls,
...
JNIEXPORT jint JNICALL Java_org_libsdl_app_sdl_SDLActivity_nativeAddJoystick(
    JNIEnv* env, jclass jcls,
...
JNIEXPORT jint JNICALL Java_org_libsdl_app_sdl_SDLActivity_nativeRemoveJoystick(
...
Java_org_libsdl_app_sdl_SDLActivity_onNativeSurfaceChanged(JNIEnv *env, jclass jcls)
{
    SDL_WindowData *data;
...
/* Surface Destroyed */
JNIEXPORT void JNICALL
Java_org_libsdl_app_sdl_SDLActivity_onNativeSurfaceDestroyed(JNIEnv *env, jclass jcls)
{
...
/* Keydown */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_onNativeKeyDown(
...
/* Keyup */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_onNativeKeyUp(
                                    JNIEnv* env, jclass jcls, jint keycode)
{
...
/* Keyboard Focus Lost */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_onNativeKeyboardFocusLost(
                                    JNIEnv* env, jclass jcls)
{
...
/* Touch */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_onNativeTouch(
                                    JNIEnv* env, jclass jcls,
...
/* Mouse */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_onNativeMouse(
                                    JNIEnv* env, jclass jcls,
...
/* Accelerometer */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_onNativeAccel(
                                    JNIEnv* env, jclass jcls,
...
/* Low memory */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_nativeLowMemory(
...
/* Quit */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_nativeQuit(
                                    JNIEnv* env, jclass cls)
{
...
/* Pause */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_nativePause(
                                    JNIEnv* env, jclass cls)
{
...
/* Resume */
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLActivity_nativeResume(
                                    JNIEnv* env, jclass cls)
{
...
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLInputConnection_nativeCommitText(
                                    JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL Java_org_libsdl_app_sdl_SDLInputConnection_nativeSetComposingText(
                                    JNIEnv* env, jclass cls,
                                    jstring text, jint newCursorPosition)
{
    const char *utftext = (*env)->GetStringUTFChars(env, text, NULL);
...
Java_org_libsdl_app_sdl_SDLActivity_nativeGetHint(JNIEnv *env, jclass cls, jstring name) {
