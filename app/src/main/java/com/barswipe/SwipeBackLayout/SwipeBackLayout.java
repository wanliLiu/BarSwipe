...
import com.barswipe.SystemBarTintManager;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    private static final int DEFAULT_SCRIM_COLOR = 0xDC000000;
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        int shadowTop = a.getResourceId(R.styleable.SwipeBackLayout_shadow_top, R.mipmap.shadow_top);
...
//            drawScrim(canvas, child);
    ...
    private void setupStatusBarView(Context context, ViewGroup decorViewGroup) {
        ...
        LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, getInternalDimensionSize(context.getResources(), "status_bar_height"));
        params.gravity = Gravity.TOP;
//        mStatusBarTintView.setLayoutParams(params);
        mStatusBarTintView.setBackgroundColor(context.getResources().getColor(R.color.colorAccent));
        decorViewGroup.addView(mStatusBarTintView, params);
    }
...
//        ViewGroup contentView = (ViewGroup) decorChild.findViewById(android.R.id.content);
//        setupStatusBarView(activity, contentView);
