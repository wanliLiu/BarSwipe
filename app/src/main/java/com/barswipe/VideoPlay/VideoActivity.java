package com.barswipe.VideoPlay;
...
import com.barswipe.View.FullScreenVideoView;
...
public class VideoActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void initView() {
        ...
        width = getWidthInPx(this);
        height = getHeightInPx(this);
        threshold = dip2px(this, 18);
    }
    ...
    protected void initData() {
        ...
        tv_title.setText("测试 video 播放网络视频");
        videoUrl = "http://mvideo.spriteapp.cn/video/2016/1026/b06390b4-9ace-11e6-99c2-d4ae5296039d_wpc.mp4";
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            height = getWidthInPx(this);
            width = getHeightInPx(this);
