package com.barswipe.DragGridView.custom;
...
public class DraggableGridViewSampleActivity extends BaseActivity {
...
//				view.setImageBitmap(getThumb(word));
                View view = LayoutInflater.from(DraggableGridViewSampleActivity.this).inflate(R.layout.drag_gradview_item_layout, null);
                ((TextView) view.findViewById(R.id.test)).setText(word);
                dgv.addView(view);
                poem.add(word);
            }
        });
