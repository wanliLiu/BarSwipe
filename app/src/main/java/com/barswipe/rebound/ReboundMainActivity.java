...
import com.barswipe.rebound.app.PlaygroundActivity;
...
/**
 * Created by Soli on 2016/11/15.
 */

public class ReboundMainActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_rebound);
        ...
        RxView.clicks(findViewById(R.id.demod))
                .subscribe(new Action1<Void>() {
                    @Override
                    public void call(Void aVoid) {
                        startActivity(new Intent(ReboundMainActivity.this, PlaygroundActivity.class));
                    }
                });
    }
