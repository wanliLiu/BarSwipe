...
//                childTop = childHeight * i;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        Log.e(TAG, "getScrollY is onInterceptTouchEvent----" + getScrollY());
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        Log.e(TAG, "getScrollY is onTouchEvent----" + getScrollY());
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if ((mTouchState == TOUCH_STATE_SCROLLING)) {
                    ...
                    if (MCOY_DEBUG) {
                        Log.e(TAG, "deltaY is " + deltaY);
                        Log.e(TAG, "scrollY is " + scrollY);
                    }
...
//        mScroller.startScroll(0, cy, 0, delta, Math.abs(delta));
        mScroller.startScroll(0, cy, 0, delta, 400);
        invalidate();
    }
