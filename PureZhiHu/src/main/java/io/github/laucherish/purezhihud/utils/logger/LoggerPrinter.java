 ...
 * @author Orhan Obut
 */
final class LoggerPrinter implements io.github.laucherish.purezhihud.utils.logger.Printer {
   ...
   */
  @Override
  public io.github.laucherish.purezhihud.utils.logger.Settings init(String tag) {
    if (tag == null) {
  ...
  @Override
  public io.github.laucherish.purezhihud.utils.logger.Settings getSettings() {
    return settings;
  }
